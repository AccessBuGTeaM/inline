bot = dofile('/home/anti/inline/utils.lua')
json = dofile('/home/anti/inline/JSON.lua')
...
BASE = '/home/anti/inline/'
SUDO = 366441416 -- sudo id
sudo_users = {366441416,325007537}
BOTS = 362530388 -- bot id
...
---------------------reload -------------------------
       ...
       dofile('./cli.lua') 
 bot.sendMessage(msg.chat_id_, msg.id_, 1,'》 <code>BuG TG</code> <b>Reloaded  ✅</b>', 1, 'html')
            end
 ...
 bot.sendMessage(msg.chat_id_, msg.id_, 1,'》 <code>BuG TG</code> <b>Reloaded  ✅</b>', 1, 'html')
	    ...
	    if text == 'BuG' and is_sudoers(msg) then
