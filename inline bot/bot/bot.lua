bot = dofile('/home/antispam/inline/data/utils.lua')
json = dofile('/home/antispam/inline/data/JSON.lua')
...
BASE = '/home/antispam/inline/bot/'
SUDO = 270097211 --sudo id
sudo_users = {270097211,123456789,Userid}
