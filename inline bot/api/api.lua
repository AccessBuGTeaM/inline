...
local json = (loadfile "/home/antispam/inline/data/JSON.lua")()
local token = '355352301:AAEQ_KC8dI7kY7olc0Aq-iJKw6R-mu236Oc' --token
 ...
 if redis:get(hash) then
    ...
    return false
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'`قیمت طرح های مربوط به این ربات:`\n`ماهانه(30 الی 31 روز کامل)` >  *5000*\n`شش ماهه(180 روز کامل)` > *10000*\n`دائمی/مادام العمر(نامحدود روز)` > *15000*\n`تمامی قیمت ها به` تومان `میباشد.`',keyboard)
            end
			------------@@@@@@@@@@@@@@@@@@@@@@@@@@------------------
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'`قیمت طرح های مربوط به این ربات:`\n`ماهانه(30 الی 31 روز کامل)` >  *15000*\n`شش ماهه(180 روز کامل)` > *20000*\n`دائمی/مادام العمر(نامحدود روز)` > *25000*\n`تمامی قیمت ها به` تومان `میباشد.`',keyboard)
            end
							----------------------------------بررسی قابلیت ها--------------------------------------
